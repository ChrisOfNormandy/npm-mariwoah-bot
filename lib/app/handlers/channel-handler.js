...
const { joinVoiceChannel, getVoiceConnection, createAudioPlayer, NoSubscriberBehavior, createAudioResource, AudioPlayer, VoiceConnection, AudioPlayerStatus } = require('@discordjs/voice');
const voiceChannel = {
    /**
     *
